...
class User {
  ...
  Future<bool> delete() async {
    ...
    try {
      ...
      List<Future<void>> allQueries2 = [];

      s.asMap().forEach((index, element) {
      ...
      await Future.wait(allQueries2);
      // for each of them, delete
      await userCollection.doc(q.docs[0].id).delete();
